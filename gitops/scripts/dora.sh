DC_URL=https://api.cluster-vtflb.vtflb.sandbox1105.opentlc.com:6443
DC_UID=admin
DC_PWD=nA59YKPVpQIFnDo2
...
AWS_URL=https://api.aws.sandbox1105.opentlc.com:6443
AWS_UID=kubeadmin
AWS_PWD=2AIhi-c9yva-vjQx2-4DyJH
AWS_TOKEN=
